...
$(function() {
    ...
    function bindFilterList() {
        ...
        $('li[data-type="filter_with"]').unbind("click").bind('click', function() {
            ...
            searchTableList();
            $('<input name=\''+field+'\' value=\''+_query[field]+'\' type=\'hidden\'>').appendTo('#search_form');
            $('#search_form').submit();
        });
    }
    ...
    function bindPopup() {
        $("[data-type=popup]").unbind("click").bind("click",function(){
            ...
            $.get(url, function(data){console.log(data);
                $("#_popup_dialog_box textarea[name=remark]").val(data);
            });


            $('#_popup_dialog_box').css('display', 'block');
            $('#_popup_dialog_box input[name=confirm]').unbind("click").bind("click",function(){
                $.post(url, {_token:token,content:$("#_popup_dialog_box textarea[name=remark]").val()});
                $('#_popup_dialog_box').css('display', 'none');
            });
            $('#_popup_dialog_box input[name=cancel]').unbind("click").bind("click",function(){
                $('#_popup_dialog_box').css('display', 'none');
            });
